...
class VideoAudioClient:
    ...
    def update_audio(self):
        ...
        if self.is_audio_on and self.audio_stream:
            audio_data = self.audio_stream.read(4096)
    ...
    def send_data(self, data_type, data):
        try:
            ...
            self.sock.sendto(packet, (self.server_ip, self.server_port))  # 使用UDP的sendto方法
...
if __name__ == "__main__":
    ...
    try:
        while client.is_running:
            client.update_video()  # 更新视频
            client.update_audio()  # 更新音频
